...
public class SaldoDenarska extends javax.swing.JApplet {
...
JPanel panela1=new JPanel();
    ...
    JLabel momentalnipari=new JLabel(Integer.toString(new Random().nextInt(50000)+5000)+"MKD");
    
    JLabel rezervirani=new JLabel("Rezervirani sredstva:");
    JLabel rezerviranipari=new JLabel(Integer.toString(new Random().nextInt(5000))+"MKD");
        System.out.println(momentalnipari.getText().indexOf('M'));
    JLabel raspolozivi=new JLabel("Raspolozivi sredstva:");
    JLabel raspolozivipari=new JLabel(Integer.toString(-Integer.parseInt(rezerviranipari.getText().substring(0, rezerviranipari.getText().indexOf('M')))+Integer.parseInt(momentalnipari.getText().substring(0, momentalnipari.getText().indexOf('M'))))+"MKD");
    ...
    JLabel nalog1=new JLabel("Bankomat 43 Kapistec ");
    JLabel opis1 =new JLabel("Bankomat 43 Kapistec ");
    JLabel iznos1=new JLabel("-3000MKD");
    ...
    JLabel nalog2=new JLabel("Bankomat 21 Kozle");
    JLabel opis2 =new JLabel("Bankomat 21 Kozle");
    JLabel iznos2=new JLabel("-4000 MKD");
    JLabel datum2=new JLabel("02.10.2012");
    ...
    JLabel opis3 =new JLabel("Ebay PayPal #BuyInCoins");
    JLabel iznos3=new JLabel("-232 MKD");
    JLabel datum3=new JLabel("01.01.2013");
